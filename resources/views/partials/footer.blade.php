<footer class="border-t" style="background-color: #c9fad9; border-color: #b0f1b9;">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 text-sm" style="color: #276e44;">
            ...
            <div>
                ...
                <ul class="space-y-1.5" style="color: #60916a;">
                    ...
                    <li><a href="{{ route('page.show', 'conditions-generales-de-vente') }}" class="hover:opacity-70 transition-opacity">CGV</a></li>
