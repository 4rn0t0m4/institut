                    ...
                    <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
                        ...
                        @if ($order->boxtal_shipping_order_id)
                            <div class="space-y-3 text-sm text-gray-600 dark:text-gray-400">
                                ...
                                <a href="{{ $order->boxtal_label_url ?: 'https://shipping.boxtal.com/fr/fr/centrale-expeditions/mes-commandes' }}" target="_blank" class="w-full inline-flex items-center justify-center gap-2 rounded-lg bg-brand-500 px-4 py-2 text-sm font-medium text-white hover:bg-brand-600 transition-colors">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                                    {{ $order->boxtal_label_url ? 'Voir / imprimer l\'étiquette' : 'Étiquette en préparation — voir sur Boxtal' }}
                                </a>
