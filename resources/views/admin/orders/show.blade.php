                ...
                <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
                    ...
                    @if ($order->boxtal_shipping_order_id)
                        <div class="space-y-3 text-sm text-gray-600 dark:text-gray-400">
                            ...
                            <a href="https://shipping.boxtal.com/dashboard/shipments" target="_blank" class="w-full inline-flex items-center justify-center gap-2 rounded-lg bg-brand-500 px-4 py-2 text-sm font-medium text-white hover:bg-brand-600 transition-colors">
