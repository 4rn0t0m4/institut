<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="lg:col-span-2 space-y-6">
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
            <p class="text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-4">Contenu de la page</p>
            <textarea id="content" name="content" class="tinymce-full">{{ old('content', $category->content ?? '') }}</textarea>
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
            ...
            @if(isset($category) && $category->exists)
                <a href="{{ $category->url() }}" target="_blank"
                   class="inline-flex items-center gap-2 text-sm text-brand-500 hover:underline mb-5">
