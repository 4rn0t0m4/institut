...
class Order extends Model
{
    ...
    protected $fillable = [
        ...
        'shipped_at', 'refunded_at', 'review_requested_at', 'abandoned_cart_reminded_at', 'customer_note',
        'gift_wrap', 'gift_type', 'gift_message',
    ];

    protected $casts = [
        'paid_at' => 'datetime', 'shipped_at' => 'datetime', 'refunded_at' => 'datetime', 'review_requested_at' => 'datetime', 'abandoned_cart_reminded_at' => 'datetime', 'gift_wrap' => 'boolean',
